...
- **سفارشی‌سازی کم‌اصطکاک:** رنگ اصلی/ثانویه، محتوای هیرو و نوار اطلاع‌رسانی، **حالت تاریک**، متن پایین صفحه، شبکه‌های اجتماعی و تعداد ستون محصولات در Customizer.
...
1. از بخش **Releases** فایل `rasta-commerce-2.3.0.zip` را دریافت کنید، یا محلی بسازید:
   ```bash
   npm ci
   npm run package
   ```
2. در پیشخوان وردپرس به **نمایش ← پوسته‌ها ← افزودن پوسته ← بارگذاری پوسته** بروید.
3. فایل `release/rasta-commerce-2.3.0.zip` را بارگذاری و فعال کنید.
